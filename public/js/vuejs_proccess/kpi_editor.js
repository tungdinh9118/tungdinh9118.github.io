...
var v = new Vue({
    ...
    methods: {
        groupClick: function(groupSlug){
            return
            var self = this;
            var groups = self.list_group.map(function(group){
                if(group.slug  === groupSlug){
                    group.click_once = true
                }
                return group
            })
            self.list_group = groups
        },
        ...
        getListGroupV2: function(){
            ...
            for(var kpi_id in self.parentKPIs){
                ...
                //
                var matchedGroup = self.findGroupBySlug(group.slug, listGroup)
